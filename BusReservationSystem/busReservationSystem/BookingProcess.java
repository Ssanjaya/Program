...
public class BookingProcess {
    ...
    public void Options() {
        ...
        while (true) {
            System.out.println("\n================");
            System.out.printf("|%-14s|%n|%-14s|%n|%-14s|%n|%-14s", "1.Booking", "2.Cancel", "3.Admin Login","4.Exit");
            System.out.println("\n================");
//        try{
                    ...
                    while (true) {
                        ...
                        for (Bus bus : admin.getBusList()) {
                            if (bus.getBusNumber() == input) {
                                System.out.println("\n ----------------------------------------------------------------------------------------------------------------------------------------------------------------");
                                System.out.printf("| %-20s | %-20s| %-18s| %-18s| %-12s|", "Bus Number", "Available Seats", "From", "TO","TRAVEL TIME", "Travel Time");
                                System.out.println("\n ----------------------------------------------------------------------------------------------------------------------------------------------------------------");
