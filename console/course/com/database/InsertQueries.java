...
public class InsertQueries {
	   private static Connection connection;
	    ...
	    static final String STUDENTPERSONAL = "insert into student_personal_details (first_name, last_name, father_name, age, date_of_birth, gender, primary_mobile_no, secondary_mobile_no, current_address, current_pincode, current_city, current_state, religion, nationality, student_id, user_id) values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
